export default {
  ...
  es: {
    hint: 'Haz click o arrastra el archivo aquí para cargarlo',
    loading: 'Cargando…',
    noSupported: 'Browser is not supported, please use IE10+ or other browsers',
    ...
    error: {
      onlyImg: 'Sólo imágenes',
      outOfSize: 'La imagen excedió el límite: ',
      lowestPx: 'El tamaño de la imagen es muy pequeño. Se espera al menos: ',
    },
  },
};
